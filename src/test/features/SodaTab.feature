Feature: Validate Incomm Soda Tab in EPS web in powerApps

  Scenario: Verify  Soda tab on Transaction Details page in EPS Web powerApps
    ...
    Then I verify the columns on the Soda tab
